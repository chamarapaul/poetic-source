...
export const poeticGroupMetadata: Record<
  PoeticGroup,
  {
    description: string;
    features: string[];
...
> = {
  'Visual Expression': {
    description:
      'Languages where spatial arrangement and visual patterns form part of the poetic expression',
    features: ['Unique symbols', 'Spatial layouts', 'Visual patterns'],
  },
  'Natural Flow': {
    description:
      'Languages designed for readability that naturally lend themselves to poetic expression',
    features: ['Readable syntax', 'Expressive structures', 'Fluid composition'],
  },
  'Structured Elegance': {
    description:
      'Languages where formal structure and strong typing create poetic constraints',
    features: [
      'Formal patterns',
      'Type-based metaphors',
      'Structured composition',
    ],
  },
  'Symbolic Patterns': {
    description:
      'Languages that excel at pattern manipulation and symbolic transformation',
    features: [
      'Pattern matching',
      'Symbolic processing',
  ...
  'Modern Synthesis': {
    description:
      'Contemporary languages that blend multiple paradigms for flexible poetic expression',
    features: ['Mixed paradigms', 'Modern syntax', 'Flexible structures'],
  },
  'System Dialogues': {
    description:
      'Languages that create poetry through direct interaction with system concepts',
    features: ['Memory metaphors', 'Hardware poetry', 'System interactions'],
  },
};

export const poeticCharacteristics: Record<
  ProgrammingLanguage,
  PoeticCharacteristic
> = {
  ada: {
    group: 'Structured Elegance',
...
export const languageMetadata: Record<ProgrammingLanguage, LanguageMetadata> = {
  ...
  ada: {
    ...
    description:
      'Elegant precision with mathematical roots, where reliability becomes poetry',
  },
  apl: {
    yearCreated: 1962,
    ...
    description:
      'Dense, symbolic notation that turns algorithms into visual poetry',
  },
  befunge: {
    yearCreated: 1993,
...
export const getLanguageDescriptions = (): Record<
  ProgrammingLanguage,
  string
> => {
