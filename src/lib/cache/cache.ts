...
export function getMetadataCache(): CachedMetadata {
  ...
  const languagesByGroup: Record<PoeticGroup, ProgrammingLanguage[]> =
    {} as Record<PoeticGroup, ProgrammingLanguage[]>;
...
export function getLanguagesByParadigm(): Record<
  string,
  ProgrammingLanguage[]
> {
...
export function getLanguagesByGroup(): Record<
  PoeticGroup,
  ProgrammingLanguage[]
> {
